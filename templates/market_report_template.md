...
Fill-in-the-blank scaffolds for the Market Analyst Agent. Replace every `[X]` / `$` placeholder with sourced, method-labeled values.
...
## Individual Competitor Analysis Template

Write to: `projects/[project-name]/resources/market-research/competitor_[name].md` (one file per competitor)
